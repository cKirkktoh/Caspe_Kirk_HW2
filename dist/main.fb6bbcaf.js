...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/recipebook.js":[function(require,module,exports) {
"use strict";
...
var Recipe = exports.Recipe = /*#__PURE__*/function () {
  function Recipe(id, name, ingredients, instructions) {
  ...
  _createClass(Recipe, [{
    ...
    value: function updateIngredients(newIngredients) {
      this.ingredients = newIngredients;
    }
  }, {
    key: "updateInstructions",
    value: function updateInstructions(newInstructions) {
      this.instructions = newInstructions;
    }
  }]);
  return Recipe;
}(); // RecipeBook class
var RecipeBook = exports.RecipeBook = /*#__PURE__*/function () {
  function RecipeBook() {
  ...
  _createClass(RecipeBook, [{
    key: "addRecipe",
    value: function addRecipe(name, ingredients, instructions) {
      var id = this.recipes.length + 1; // Generate unique ID
      var recipe = new Recipe(id, name, ingredients, instructions);
...
var _recipebook = require("./recipebook.js");
var recipeBook = new _recipebook.RecipeBook();
...
function addRecipe() {
  ...
  var ingredients = document.querySelector('#recipeIngredients').value;
  var instructions = document.querySelector('#recipeInstructions').value;
...
function renderRecipes() {
  ...
  recipeBook.getRecipes().forEach(function (recipe) {
    var recipeItem = document.createElement('li');
    var recipeNameHeading = document.createElement('h3');
...
renderRecipes();
},{"./recipebook.js":"js/recipebook.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
